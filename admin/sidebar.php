    ...
    <nav class="side-nav accordion navbar-dark bg-dark side-nav-dark" id="sidenavAccordion">
        <div class="side-nav-menu">
            <div class="nav">
                ...
                <a class="nav-link active" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayoutReports"
                    aria-expanded="true" aria-controls="collapseLayoutReports">
                ...
                <?php } ?>
                <?php if ($view == 'reports' || $view == 'activity-log' || $view == 'contact-log') { ?>
                <div class="collapse show" id="collapseLayoutReports" aria-labelledby="headingOne"
                    ...
                    <div class="collapse" id="collapseLayoutReports" aria-labelledby="headingOne"
                        ...
                        <nav class="side-nav-menu-nested nav">
                            ...
                            <a class="nav-link <?php if (($view == 'reports' && isset($_GET['type'])) && ($_GET['type'] == 'Top Field by School')) {
                                ...
                                Field by School</a>
                            <a class="nav-link <?php if (($view == 'reports' && isset($_GET['type'])) && ($_GET['type'] == 'Major to Field Ratio by School')) {
                                                    echo 'active';
                                                } ?>"
                    ...
                    <a class="nav-link active" href="#" data-bs-toggle="collapse"
                        data-bs-target="#collapseLayoutDegrees" aria-expanded="true"
                        aria-controls="collapseLayoutDegrees">
                    ...
                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                        data-bs-target="#collapseLayoutDegrees" aria-expanded="false"
                        aria-controls="collapseLayoutDegrees">
                        <div class="sb-nav-link-icon"><i class="fa-solid fa-graduation-cap"></i></div>
                        Degree Programs
                        <div class="side-nav-collapse-arrow"><i class="fa-solid fa-chevron-down"></i></div>
                    ...
                    <?php } ?>
                    <?php if ($view == 'majors' || $view == 'degrees') { ?>
                    <div class="collapse show" id="collapseLayoutDegrees" aria-labelledby="headingOne"
                        data-bs-parent="#sidenavAccordion">
                        <?php } else { ?>
                        ...
                        <a class="nav-link active" href="#" data-bs-toggle="collapse"
                            ...
                            aria-controls="collapseLayoutUsers">
                        ...
                        <?php } else { ?>
                        <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                            data-bs-target="#collapseLayoutUsers" aria-expanded="false"
                            aria-controls="collapseLayoutUsers">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-users"></i></div>
                            Users/Roles
                            <div class="side-nav-collapse-arrow"><i class="fa-solid fa-chevron-down"></i></div>
                        ...
                        <?php } ?>
                        <?php if ($view == 'users' || $view == 'roles') { ?>
                        <div class="collapse show" id="collapseLayoutUsers" aria-labelledby="headingOne"
                            data-bs-parent="#sidenavAccordion">
                            <?php } else { ?>
