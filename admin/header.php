...
<body class="nav-fixed">
    <nav class="top-nav navbar navbar-expand navbar-dark bg-dark">
        ...
        <!-- Navbar Search-->
        <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" action="<?php echo APP_URL . '/admin/dashboard.php?view=search'; ?>" method="post">
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="<?php echo APP_URL . '/admin/dashboard.php?view=settings' ?>">Settings</a></li>
