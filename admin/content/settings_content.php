            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <form class="form-inline" <?php if ($hasUpdateSettingsPermission) {
                                                                echo 'method="post"';
                                                            } ?> enctype="multipart/form-data" action="<?php if ($hasUpdateSettingsPermission) {
                                                                                                            echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?view=' . $_GET['view'];
                                                                                                        } else {
                                                                                                            echo '"#"';
                                                                                                        } ?>">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div id="mailer-settings">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-row">
                                        ...
                                        <select class="form-control" id="mail-mailer" <?php if (!$hasUpdateSettingsPermission) {
                                                                                                        echo 'disabled';
                                                                                                    } ?>>
                                            <?php
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-check" id="mail-auth-req">
                                            <input class="form-check-input" type="checkbox" value="" id="mail-auth-req"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <select class="form-control" id="mail-encryption" <?php if (!$hasUpdateSettingsPermission) {
                                                                                                            echo 'disabled';
                                                                                                        } ?>>
                                            <?php
                            ...
                            <div class="form-row">
                                <button type="submit" class="btn btn-primary" <?php if (!$hasUpdateSettingsPermission) {
                                                                                                echo 'disabled';
                                                                                            } ?>>Save</button>
                                <button type="reset" class="btn btn-secondary" <?php if (!$hasUpdateSettingsPermission) {
                                                                                                echo 'disabled';
                                                                                            } ?>>Reset</button>
                            </div>
                    </form>
