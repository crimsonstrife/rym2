    ...
    <main>
        <?php
                if (isset($_GET['media'])) {
                    switch ($_GET['media']) {
                        case 'list':
                            include_once('./view/list/media_list.php');
                            break;
                        case 'add':
                                ...
                                switch ($_GET['action']) {
                                    case 'create':
                                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                            include_once('./editor/actions/media/create.php');
                                        } else {
                                            include_once('./editor/media_edit.php');
                                        }
                                        break;
                                    default:
                                        include_once('./view/list/media_list.php');
                        ...
                        case 'edit':
                            if (isset($_GET['action'])) {
                                switch ($_GET['action']) {
                                    case 'edit':
                                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                            include_once('./editor/actions/media/modify.php');
                                        } else {
                                            include_once('./editor/media_edit.php');
                                        }
                                        break;
                        ...
                        case 'single':
                            if (isset($_GET['action'])) {
                                switch ($_GET['action']) {
                                    case 'delete':
                                        include_once('./editor/actions/media/delete.php');
                                        break;
                                    default:
                                        include_once('./view/single/media_single.php');
                                        break;
                                }
                            } else {
                                include_once('./view/single/media_single.php');
