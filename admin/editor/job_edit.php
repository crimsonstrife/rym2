                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <p>
                                    <strong>
                                        <label for="jobTitle">Job Title: <strong><span
                            ...
                            <div class="form-group">
                                <p>
                                    <strong>
                                        <label for="jobSummary">Job Summary: <strong><span
                                                    class="required">*</span></strong></label>
                                    </strong>
                                </p>
                                <p>
                                    <textarea id="jobSummary" name="job_summary" class="form-control" rows="3"
                                        maxlength="200"
                                        placeholder="<?php echo $job->getJobSummary(intval($job_id)); ?>"
                                        required><?php echo $job->getJobSummary(intval($job_id)); ?></textarea>
                                </p>
                                ...
                                <div id="counter hint-text"><span id="jobSummaryCounter"><small id="summaryCounterText"
                                            class="form-text text-muted">200/200</small><small
                            ...
                            <div class="form-group">
                                <p>
                                    <strong>
                                        <label for="jobDescription">Job Description: <strong><span
                                                    class="required">*</span></strong></label>
                                    </strong>
                                </p>
                                <p>
                                    <textarea id="jobDescription" name="job_description"
                                        class="form-control wysiwyg-editor" rows="10"
                            ...
                            <div class="form-group">
                                <p>
                                    <strong>
                                        <label for="jobType">Job Type: <strong><span
                                                    class="required">*</span></strong></label>
                                    </strong>
                                </p>
                                <p>
                            ...
                            <div class="form-group">
                                <p>
                                    <strong>
                                        <label for="jobField">Job Field: <strong><span
                                                    class="required">*</span></strong></label>
                                    </strong>
                                </p>
                                <p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" id="jobSkills" name="job_skills" class="form-control"
                                        placeholder="Job Skills">
                                    <!-- button to add a new skill to list -->
                                    <input type="button" id="addSkill" name="add_skill"
                                        class="form-control btn btn btn-outline-success btn-skill-btn btn-add"
                                        value="Add Skill">
                                </div>
                                <div class="input-group mb-3">
                                    <!-- list of skills -->
                                    <ul id="jobSkillsList" name="job_skills_list"
                                        class="form-control list-group job-skill-list">
                                        <?php
                                    ...
                                    <input type="button" id="removeSkill" name="remove_skill"
                                        class="form-control btn btn btn-outline-danger btn-skill-btn btn-remove"
                                        value="Remove Skill">
                            ...
                            <div class="form-group">
                                <p>
                                    <strong>
                                        <label for="jobField">Education Requirement: <strong><span
                                                    class="required">*</span></strong></label>
                                    </strong>
                                </p>
                                <p>
                                    <select id="jobEducation" name="job_education" class="form-control app-forms"
                                        required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <p>
                                        <textarea id="jobSummary" name="job_summary" class="form-control" rows="3"
                                            maxlength="200" placeholder="Job Summary" required></textarea>
                                    </p>
                                    <p><small id="jobSummaryHelp" class="form-text text-muted">Enter a summary for
                                            the job, under 200 characters.</small></p>
                                    <p>
                                        <!-- counter for job summary -->
                                    <div id="counter hint-text"><span id="jobSummaryCounter"><small
                                                id="summaryCounterText"
                                                class="form-text text-muted">200/200</small><small
                                                class="form-text text-muted">
                                                characters remaining</small></span></div>
                                    </p>
                                ...
                                <div class="form-group">
                                    ...
                                    <p>
                                        <textarea id="jobDescription" name="job_description"
                                            class="form-control wysiwyg-editor" rows="10" placeholder="Job Description"
                                            required></textarea>
                                    </p>
                                    <p><small id="jobDescriptionHelp" class="form-text text-muted">Enter a
                                            description for the job, can use HTML to style the text.</small></p>
