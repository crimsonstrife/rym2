                        ...
                        <div class="col-md-6">
                            ...
                            <p>
                                <textarea id="jobSummary" name="job_summary" class="form-control" rows="3"
                                    maxlength="200" placeholder="<?php echo $job->getJobSummary(intval($job_id)); ?>"
                            ...
                            <div id="counter hint-text"><span id="jobSummaryCounter"><small id="summaryCounterText"
                                        class="form-text text-muted">200/200</small><small class="form-text text-muted">
                            ...
                            <p>
                                <textarea id="jobDescription" name="job_description" class="form-control wysiwyg-editor"
                                    rows="10" placeholder="<?php echo $job->getJobDescription(intval($job_id)); ?>"
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>
                                <textarea id="jobDescription" name="job_description" class="form-control wysiwyg-editor"
                                    rows="10" placeholder="Job Description" required></textarea>
                            </p>
                            <p>
                                <strong>
                                    <label for="jobType">Job Type:</label>
