    ...
    if (isset($_GET['action'])) {
        ...
        if ($action == 'edit') {
            ...
            if (!empty($userData)) {
                ...
                if (!$hasUpdateUserPermission && !$editingSelf) {
                    //set the error type
                            ...
                            <div class="form-group">
                                ...
                                <p>
                                    <input type="text" id="username" name="user_name" class="form-control"
                                        value="<?php echo $user->getUserUsername($user_id); ?>"
                                        placeholder="<?php echo $user->getUserUsername($user_id); ?>" required disabled
                                        readonly>
                                </p>
                                <p>
                                    <strong>
                                ...
                                <p>
                                    <input type="email" id="email" name="user_email" class="form-control"
                                        value="<?php echo $user->getUserEmail($user_id); ?>"
                                        placeholder="<?php echo $user->getUserEmail($user_id); ?>" required>
                                </p>
                                <p>
                                    <strong>
