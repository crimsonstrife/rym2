                        ...
                        <div class="row">
                            <div class="col-md-6" style="height: 100%;">
                                ...
                                <div id="eventBranding">
                                    ...
                                    <img src="<?php echo getUploadPath() . $media->getMediaFileName($event->getEventLogo($event_id)); ?>" alt="Event Logo" style="max-width: 200px; max-height: auto;">
                                    <p><strong>Event Banner:</strong></p>
                                    <img src="<?php echo getUploadPath() . $media->getMediaFileName($event->getEventBanner($event_id)); ?>" alt="Event Banner" style="max-width: 200px; max-height: auto;">
                                    <p><strong>School Logo:</strong></p>
                                    <img src="<?php echo getUploadPath() . $media->getMediaFileName($school->getSchoolLogo(intval($event->getEventLocationId($event_id)))); ?>" alt="School Logo" style="max-width: 200px; max-height: auto;">
