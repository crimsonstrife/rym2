...
?>
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <div class="card-buttons">
                            <a href="<?php echo APP_URL . '/admin/dashboard.php?view=media&media=list'; ?>" class="btn btn-secondary">Back to Media</a>
                            ...
                            if ($hasUpdatePermission) { ?>
                                <a href="<?php echo APP_URL . '/admin/dashboard.php?view=media&media=edit&action=edit&id=' . $media_id; ?>" class="btn btn-primary">Edit Media</a>
                            <?php } ?>
                            ...
                            if ($hasDeletePermission) { ?>
                                <button type="button" id="openDeleteModal" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteMediaModal">
                                    Delete Media
                                </button>
                            <?php } ?>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" style="height: 100%;">
                                ...
                                <div id="info" class="">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="img-container" style="background-image: url('<?php echo getAssetPath() . 'img/transparency.svg' ?>'); background-size:cover;">
                                                <img src="<?php echo $media->getMediaFilePath(intval($media_id)); ?>" alt="<?php echo $mediaData['filename']; ?>" class="img-fluid">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                                ...
                                                                <tbody>
                                                                    <?php foreach ($eventUsageData as $eventUsage) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><a href="<?php echo APP_URL . '/admin/dashboard.php?view=events&event=single&id=' . $event_id; ?>" class="btn btn-primary">View Event</a></td>
                                                                        </tr>
                                                                    <?php } ?>
                                                                </tbody>
                                                            <?php } else { ?>
                                                                ...
                                                                <tbody>
                                                                    <?php foreach ($schoolUsageData as $schoolUsage) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><a href="<?php echo APP_URL . '/admin/dashboard.php?view=schools&school=single&id=' . $school_id; ?>" class="btn btn-primary">View School</a></td>
                                                                        </tr>
                                                                    <?php } ?>
                                                                </tbody>
                                                            <?php } else { ?>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form action="<?php echo APP_URL . '/admin/dashboard.php?view=media&media=single&action=delete&id=' . $media_id; ?>" method="post">
    ...
    ${
    options.searchable ?
        `<div class='${options.classes.search} float-right search
