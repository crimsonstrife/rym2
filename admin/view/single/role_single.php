                ...
                <div class="card-header">
                    ...
                    <div class="card-buttons">
                        ...
                        if ($hasUpdatePermission) { ?>
                            <a href="<?php echo APP_URL . '/admin/dashboard.php?view=roles&role=edit&action=edit&id=' . $roleId; ?>" class="btn btn-primary">Edit Role</a>
                        <?php } ?>
                        ...
                        if ($hasDeletePermission) {
                            ...
                            if ($superAdminCount <= 1) {
                                ...
                                if ($roleHasSuperPermission) {
                                    ...
                                    <button type="button" id="openDeleteModal" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteRoleModal">
                                        Delete Role
                                    </button>
                        <?php }
                            }
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="<?php echo APP_URL . '/admin/dashboard.php?view=roles&role=single&action=delete&id=' . $roleId; ?>" method="post">
