            ...
            <div class="card mb-4">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="td-actions">
                                                ...
                                                if ($hasReadPermission) { ?>
                                                    <a href="<?php echo APP_URL . '/admin/dashboard.php?view=roles&role=single' ?>&id=<?php echo $role['id']; ?>" class="btn btn-success">View Role</a>
                                                <?php } ?>
                                                ...
                                                if ($hasUpdatePermission) { ?>
                                                    <a href="<?php echo APP_URL . '/admin/dashboard.php?view=roles&role=edit&action=edit&id=' . $role['id']; ?>" class="btn btn-primary">Edit Role</a>
                                                <?php } ?>
                                                ...
                                                if ($hasDeletePermission) {
                                                    ...
                                                    if ($superAdminCount <= 1) {
                                                        ...
                                                        if ($roleHasSuperPermission) {
                                                            ...
                                                            <button type="button" id="openDeleteModal" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteRoleModal" onclick="setDeleteID(<?php echo $role['id']; ?>)">
                                                                Delete Role
                                                            </button>
                ...
                <?php if ($hasDeletePermission) { ?>
                    <div id="info" class="">
                        <!-- Delete Role Modal-->
                        <!-- Modal -->
                        <div id="deleteRoleModal" class="modal fade delete" tabindex="-1" role="dialog" aria-labelledby="#roleDeleteModal" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title" id="roleDeleteModal">Delete Role - <span id="roleName-Title">Role Name</span></h3>
