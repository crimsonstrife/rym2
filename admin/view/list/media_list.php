                                            ...
                                            <div class="col-md-3">
                                                <div class="thumbnail">
                                                    ...
                                                    <div class="thumbnail-container" style="background-image: url('<?php echo getAssetPath() . 'img/transparency.svg' ?>'); background-size:cover;">
                                                        <img id="thumbnail" class="img-thumbnail" src="<?php echo getUploadPath() . $mediaFilename; ?>" alt="<?php echo $mediaFilename; ?>">
                                                    </div>
                                                    <div class="caption">
                                                        <span class="td-actions">
                                                            <?php /*confirm user has a role with read media permissions*/
                                                            ...
                                                            //only show the edit button if the user has the read media permission
                                                            if ($hasReadPermission) { ?>
                                                                <button type="button" id="openReadModal" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#readMediaModal" onclick="setReadID(<?php echo $mediaArray[$mediaIndex]['id']; ?>)">
                                                                    View Media
                                                                </button>
                                                            <?php } ?>
                                                        </span>
