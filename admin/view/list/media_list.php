            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        ?>
                            <a href="<?php echo APP_URL . '/admin/dashboard.php?view=media&media=add&action=create' ?>" class="btn btn-primary">Add Media</a>
                        <?php } ?>
                        <!-- Media View Toggle -->
                        <div class="btn-group btn-group-toggle">
                            <button type="button" class="btn btn-secondary active" autocomplete="off" id="listView" onclick="toggleMediaView('list')">List View</button>
                            <button type="button" class="btn btn-secondary" id="galleryView" autocomplete="off" onclick="toggleMediaView('gallery')">Gallery View</button>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="td-actions">
                                                ...
                                                if ($hasReadPermission) { ?>
                                                    <a href="<?php echo APP_URL . '/admin/dashboard.php?view=media&media=single' ?>&id=<?php echo $media['id']; ?>" class="btn btn-success">View Media</a>
                                                <?php } ?>
                                                ...
                                                if ($hasUpdatePermission) { ?>
                                                    <a href="<?php echo APP_URL . '/admin/dashboard.php?view=media&media=edit&action=edit&id=' . $media['id']; ?>" class="btn btn-primary">Edit Media</a>
                                                <?php } ?>
                                                ...
                                                if ($hasDeletePermission) { ?>
                                                    <button type="button" id="openDeleteModal" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteMediaModal" onclick="setDeleteID(<?php echo $media['id']; ?>)">
                                                        Delete Media
                                                    </button>
                                                <?php } ?>
                                            </span>
                                            ...
                                            <div class="col-md-3">
                                                <div class="thumbnail">
                                                    ...
                                                    <div class="thumbnail-container" style="background-image: url('<?php echo getAssetPath() . 'img/transparency.svg' ?>'); background-size:cover;">
                                                        <img id="thumbnail" class="img-thumbnail" src="<?php echo getUploadPath() . $mediaData->getMediaThumbnail(intval($mediaID)); ?>" alt="<?php echo $mediaFilename; ?>">
                                                    </div>
                                                    <div class="caption">
                                                        <span class="td-actions">
                                                            <?php /*confirm user has a role with read media permissions*/
                                                            ...
                                                            //only show the edit button if the user has the read media permission
                                                            if ($hasReadPermission) { ?>
                                                                <button type="button" id="openReadModal" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#readMediaModal" onclick="setReadID(<?php echo $mediaID; ?>)">
                                                                    View Media
                                                                </button>
                                                            <?php } ?>
                                                        </span>
                ...
                <?php if ($hasDeletePermission) { ?>
                    <div id="info" class="">
                        <!-- Delete Media Modal-->
                        <!-- Modal -->
                        <div id="deleteMediaModal" class="modal fade delete" tabindex="-1" role="dialog" aria-labelledby="#mediaDeleteModal" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title" id="mediaDeleteModal">Delete Media - <span id="mediaName-Title">Media Name</span></h3>
                ...
                <?php if ($hasReadPermission) { ?>
                    <div id="info" class="">
                        <!-- Read Media Modal-->
                        <!-- Modal -->
                        <div id="readMediaModal" class="modal fade read" tabindex="-1" role="dialog" aria-labelledby="#mediaReadModal" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title" id="mediaReadModal">Read Media - <span id="mediaName-Title">Media Name</span></h3>
                                        <button type="button" class="btn-close close" data-bs-dismiss="modal" aria-label="Close">
                                            <i class="fa-solid fa-times"></i>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="container">
                                            <div class="row">
                                                <!-- Media Image -->
                                                <div class="col-md-6">
                                                    <div class="modal-thumbnail-container" style="background-image: url('<?php echo getAssetPath() . 'img/transparency.svg' ?>'); background-size:cover;">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <span class="td-actions">
                                                <form id="readMediaForm" action="" method="post">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="clearReadID()">Cancel</button>
                                                    <?php /*confirm user has a role with read media permissions*/
                                                    //get the read media permission id
                                                    $updatePermissionID = $permissionsObject->getPermissionIdByName('READ MEDIA');
                                                    ...
                                                    //only show the edit button if the user has the read media permission
                                                    if ($hasReadPermission) { ?>
                                                        <a id="view-media-btn" href="<?php echo APP_URL . '/admin/dashboard.php?view=media&media=single' ?>&id=<?php /** Need to find a way to load this on demand */ ?>" class="btn btn-success">View Media</a>
                                                    <?php } ?>
                                                    <?php /*confirm user has a role with update media permissions*/
                                                    //get the update media permission id
                                                    $updatePermissionID = $permissionsObject->getPermissionIdByName('UPDATE MEDIA');
                                                    ...
                                                    //only show the edit button if the user has the update media permission
                                                    if ($hasUpdatePermission) { ?>
                                                        <a id="update-media-btn" href="<?php echo APP_URL . '/admin/dashboard.php?view=media&media=edit&action=edit&id=';
                                                                                        /** Need to find a way to load this on demand */ ?>" class="btn btn-primary">Edit Media</a>
                                                    <?php } ?>
                                                    <?php /*confirm user has a role with delete media permissions*/
                                                    //get the delete media permission id
                                                    $deletePermissionID = $permissionsObject->getPermissionIdByName('DELETE MEDIA');
                                                    ...
                                                    //only show the delete button if the user has the delete media permission
                                                    if ($hasDeletePermission) { ?>
                                                        <button type="button" id="openDeleteModal" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteMediaModal" onclick="setDeleteID(/** Need to find a way to load this on demand */)">
                                                            Delete Media
                                                        </button>
                                                    <?php } ?>
                                                </form>
