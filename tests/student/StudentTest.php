...
class StudentTest extends TestCase
{
    ...
    public function test1_AddStudent()
    {
        ...
        if ($result) {
            error_log('Test StudentTest::test1_AddStudent Result: PASS - Student added');
        } else {
            error_log('Test StudentTest::test1_AddStudent Result: FAIL - Student not added');
        }
        ...
        //log the result message is the ID an integer
        if (is_int($this->testStudentId)) {
            error_log('Test StudentTest::test1_AddStudent Student ID: ' . $this->testStudentId);
        } else {
            error_log('Test StudentTest::test1_AddStudent Student ID: FAIL - Student ID is not an integer');
        }

        //check if the student ID is greater than 0
        $this->assertGreaterThan(0, $this->testStudentId);

        //log the result message is the ID greater than 0
        if ($this->testStudentId > 0) {
            error_log('Test StudentTest::test1_AddStudent Student ID: PASS - Student ID is greater than 0');
        } else {
            error_log('Test StudentTest::test1_AddStudent Student ID: FAIL - Student ID is not greater than 0');
        }
    ...
    public function test2_GetStudent()
    {
        ...
        if (!empty($student) && $student != null) {
            error_log('Test StudentTest::test2_GetStudent Result: PASS - Student found');
        } else {
            error_log('Test StudentTest::test2_GetStudent Result: FAIL - Student not found');
        }
        ...
        //log the result messages if the student information matches the expected values
        if ($this->firstName == $resultFirstName && $this->lastName == $resultLastName && $this->email == $resultEmail && $this->phone == $resultPhone && $this->address == $resultAddress && $this->city == $resultCity && $this->state == $resultState && $this->zipcode == $resultZipcode && $this->school == $resultSchool) {
            error_log('Test StudentTest::test2_GetStudent Result: PASS - Student information matches expected values');
        } else {
            error_log('Test StudentTest::test2_GetStudent Result: FAIL - Student information does not match expected values');
        }
    }
    ...
    public function test3_UpdateStudent()
    {
        ...
        //log the result message
        if ($result) {
            error_log('Test StudentTest::test3_UpdateStudent Result: PASS - Student updated');
        } else {
            error_log('Test StudentTest::test3_UpdateStudent Result: FAIL - Student not updated');
        }
    }
    ...
    public function test4_DeleteStudent()
    {
        ...
        //log the result message
        if ($result) {
            error_log('Test StudentTest::test4_DeleteStudent Result: PASS - Student deleted');
        } else {
            error_log('Test StudentTest::test4_DeleteStudent Result: FAIL - Student not deleted');
        }
    }
}
