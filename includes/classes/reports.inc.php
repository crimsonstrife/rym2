<?php
/**
 * Reports Class file for the College Recruitment Application
 * This class is used to manage reports for the application and store them in the database
 *
