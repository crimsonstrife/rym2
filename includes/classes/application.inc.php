<?php
/**
 * Application Class file for the College Recruitment Application
 * This class is used to manage settings and features for the application
 *
